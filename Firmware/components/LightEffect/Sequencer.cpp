...
EffectSequencer::EffectSequencer(
    uint16_t const templateLength, uint8_t targetCount, uint8_t const fadeSteps)
...
void EffectSequencer::SetEffect(
    const Sequence *sequence, Color_t const *sColor, uint8_t intens, uint8_t delay) {
